  ...
  return (
    <main className="relative w-full space-y-6 md:space-y-12">
      <div className="relative px-4 max-w-7xl w-full m-auto">
        ...
        <section aria-label="Home Hero" className="relative pb-32 pt-28 h-screen sm:h-full sm:gap-72 md:gap-80 lg:gap-72 flex flex-col items-center justify-between">
          <Quote />
