...
const components: MDXComponents = {
  ...
  h4: ({ children }) => <h4 className="text-xl font-bold mb-1 mt-2">{children}</h4>,
  h5: ({ children }) => <h5 className="text-lg font-bold mb-1 mt-2">{children}</h5>,
  h6: ({ children }) => <h6 className="text-base font-bold mb-1 mt-2">{children}</h6>,
